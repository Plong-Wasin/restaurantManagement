...
<div class="wrapper d-flex align-items-stretch">
	...
	<div id="content">
		<br>
		<h1 style=" background-color: #fff;font-family: 'Raleway',sans-serif; font-size: 62px; font-weight: 800; line-height: 72px; margin: 0 0 24px; text-align: center; text-transform: uppercase;">ผลสรุปการขาย</h1>
		<br>
		<iframe src="../Staff/StaffScreen.php" frameborder="0" style="width: 100% ;height:100%;"></iframe>
	</div>
</div>
