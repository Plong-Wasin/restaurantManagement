...
<div class="wrapper d-flex align-items-stretch">
		...
		<div class="p-4">
			...
			<ul class="list-unstyled components mb-5">
				...
				if ($_SESSION['role'] == 'admin' || $_SESSION['role'] == 'ServiceStaff') { ?>
					<li class="active">
						<a href="SidebarorderStaffScreen.php" class="w3-bar-item w3-button"><span class="fa fa-cutlery mr-3"></span>สั่งอาหาร</a>
					</li>
				<?php
				}
	...
	<div id="content">
		...
		<iframe src="../Staff/StaffScreen.php" frameborder="0" style="width: 90% ;height:100%;"></iframe>
	</div>
</div>
